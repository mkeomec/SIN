function [snr_requested, snr_theoretical, snr_empirical, target_empirical, attenuation, noise_empirical, target_theoretical, noise_theoretical, haspi] = analysis_Hagerman_test(results)
%% DESCRIPTION:
%
...
results.RunTime.analysis.params
results.RunTime.analysis.params.run_haspi=1
d = varargin2struct(results.RunTime.analysis.params);
